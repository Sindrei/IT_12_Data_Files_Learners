...
{ A TSong class containing the attributes Artist, Song, Album, TrackNumber and
  Duration (in seconds) and the
  following methods:
...
type
  ...
  public
    ...
    Constructor Create(sArtist, sSong, sAlbum: String;
      iTrackNumber, iDuration: Integer); overload;
...
var
  iMin, iSec: Integer;
begin
  // The getMinuteDuration function converts the song duration from seconds
...
begin
  // The getQuickReference function returns a string in the format ‘Song,~Album~Artist’.
