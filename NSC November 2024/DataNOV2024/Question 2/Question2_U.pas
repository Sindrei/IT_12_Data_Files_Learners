...
begin
  ...
  sOrganiser := InputBox('Organiser',
    'Enter the name of the organiser to remove', 'Active Events');
  // Question 2.2.1
  tblMarathons.First;
